 ...
 */
final class Version20240325163741 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (isbn VARCHAR(13) NOT NULL, user_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, info JSON DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, PRIMARY KEY(isbn))');
